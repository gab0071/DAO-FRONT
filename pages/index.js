...
export default function Home() {
  ...
  function renderViewProposalsTab() {
    if (loading) {
      ...
      return (
        <div className={styles.description}>No proposals have been created yet 😢</div>
      );
    } else {
      return (
        <div>
  ...
  return (
    <div>
      ...
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to CatellaTech!</h1>
